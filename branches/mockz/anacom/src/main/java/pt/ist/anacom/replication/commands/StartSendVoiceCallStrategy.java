...
public class StartSendVoiceCallStrategy extends WriteCommandStrategy {

    private final CommunicationDto communicationDto;
    private final CommunicationType communicationType;

    public StartSendVoiceCallStrategy(BusinessQueryManager businessQueryManager, CommunicationDto communicationDto, String prefix) throws MalformedURLException {
    ...
    public void sendToReplicas() {
        for (String url : urlList) {
            ...
            Logger.getLogger(this.getClass()).info("[ANACOM] Async startReceiveVoiceCall(" + communicationDto.getSourcePhoneNumber()
            ...
            if (port != null) {
                ...
                port.startSendVoiceCallAsync(communicationType, handlerResponse);
            }
        }
    }
}
