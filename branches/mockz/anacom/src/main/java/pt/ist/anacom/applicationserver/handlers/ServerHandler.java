            ...
            try {
                ...
                if (soapHeader != null) {
                    ...
                    if (signature != null) {
                        ...
                        CertificateListDto listDto = ApplicationServerWebService.bridge.getOperatorRevokedCertificateList(dto);
                        ...
                        for (CertificateDto certDto : listDto.getCertificateList()) {
                            ...
                            ApplicationServerWebService.operatorINFO.getRevokedList().add(signed);
                        }
