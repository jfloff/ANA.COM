    ...
    public boolean handleMessage(SOAPMessageContext context) {
        ...
        if (!outboundProperty.booleanValue()) {
            ...
            try {
                ...
                Name name = soapEnvelope.createName("entity", "security", "http://ca.essd.0403");
                SOAPElement element = soapHeader.addHeaderElement(name);
                element.addTextNode(CertificateAuthorityWebService.name);

                Properties properties = SecurityData.readPropertiesFile(CertificateAuthorityWebService.filePath);
                ...
                // Name certName = soapEnvelope.createName("certificate", "security",
                // "http://ca.essd.0403");
