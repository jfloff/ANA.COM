...
public class IncreasePhoneBalanceServiceTest extends AnacomServiceTestCase {
    ...
    public void testIncreasePhoneBalanceGreaterThanLimit() {
        ...
        try {
            ...
            // Assert
            assertEquals("The balance of phone should not be increased by " + AMOUNT_EXCEED_TO_INCREASE + ". Balance should stay the same ", currentBalance, getPhoneBalance(NUMBER));
        }
    ...
    public void testIncreaseNegativeAmountPhoneBalance() {
        ...
        try {
            ...
            // Assert
            assertEquals("The balance of phone should not be increased by " + AMOUNT_NEGATIVE_TO_INCREASE + ". Balance should stay the same ", currentBalance, getPhoneBalance(NUMBER));
        }
