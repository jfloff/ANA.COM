...
public class AnacomServiceTestCase extends TestCase {
    ...
    protected boolean checkLastCommunication(String sourceNumber, LastCommunicationDto lastCommunication) {
        ...
        try {
            ...
            if (communication.getDestinationPhoneNumber() == lastCommunication.getDestinationPhoneNumber() && communication.getCost() == lastCommunication.getCost() && communication.getType() == lastCommunication.getCommunicationType() && communication.getLength() == lastCommunication.getLength())
                res = true;
