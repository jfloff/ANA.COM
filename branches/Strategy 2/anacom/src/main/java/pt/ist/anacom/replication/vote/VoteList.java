...
public class VoteList {
     ...
     */
    public VoteList(ArrayList<Integer> versions, ArrayList<Object> reqTypesResponses, Set<String> responseURLList) {
        
        for (int i = 0; i < versions.size(); i++)
            addVote(versions.get(i), reqTypesResponses.get(i));
    ...
    public Object getBestResponse(int quorumLength) {
        ...
        for (Vote vote : voteList) {
            ...
            if (vote.getCounter() >= Math.round(length)) {
