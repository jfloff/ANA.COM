...
public class SendSMSStrategy extends WriteCommandStrategy {

    private final SMSDto _SMSDto;
    private final SMSType _SMSType;

    public SendSMSStrategy(BusinessQueryManager businessQueryManager, SMSDto _SMSDto, String prefix) throws MalformedURLException {
    ...
    public void sendToReplicas() {
        for (String url : urlList) {
            ...
            Logger.getLogger(this.getClass()).info("[ANACOM] Async sendSMS(" + _SMSDto.getSourcePhoneNumber() + ") New version : " + nextVersion);
            ...
            if (port != null) {
                ...
                port.sendSMSAsync(_SMSType, handlerResponse);
            }
        }
    }
}
