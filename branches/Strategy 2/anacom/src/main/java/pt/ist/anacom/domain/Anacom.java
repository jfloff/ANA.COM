...
public class Anacom extends Anacom_Base {
    ...
    public void endSourceVoiceCall(String sourcePhoneNumber, String destinationPhoneNumber, int duration) {
        ...
        Voice activeCommunication = (Voice) sourcePhone.checkActiveCommunication(sourcePhoneNumber, destinationPhoneNumber, AnacomData.CommunicationType.VOICE);
    ...
    public void endDestinationVoiceCall(String sourcePhoneNumber, String destinationPhoneNumber, int duration) {
        ...
        Voice activeCommunication = (Voice) destinationPhone.checkActiveCommunication(sourcePhoneNumber, destinationPhoneNumber, AnacomData.CommunicationType.VOICE);
        activeCommunication.setDuration(duration);
