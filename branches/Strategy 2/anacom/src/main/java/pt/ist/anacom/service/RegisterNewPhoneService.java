...
public class RegisterNewPhoneService extends AnacomService {
    ...
    public final void dispatch() throws PhoneAlreadyExistsException, PhoneAndOperatorPrefixDoNotMatchException, OperatorPrefixDoesNotExistException, PhoneNumberWrongLengthException {
