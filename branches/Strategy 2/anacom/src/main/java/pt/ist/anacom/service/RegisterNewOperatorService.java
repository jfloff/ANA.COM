...
public class RegisterNewOperatorService extends AnacomService {
    ...
    public final void dispatch() throws OperatorPrefixAlreadyExistsException, OperatorPrefixWrongLengthException, OperatorNullNameException, InvalidTaxException, OperatorNameAlreadyExistsException {

        Anacom anacom = FenixFramework.getRoot();
        anacom.addOperator(this.operatorDto.getOperatorPrefix(), this.operatorDto.getOperatorName(), this.operatorDto.getOperatorTax(), this.operatorDto.getOperatorTaxVoice(), this.operatorDto.getOperatorTaxSMS(), this.operatorDto.getOperatorTaxVideo(), this.operatorDto.getOperatorTaxBonus());
    }
}
