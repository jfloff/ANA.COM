...
public class ProcessEndSourceVoiceCallService extends AnacomService {
    ...
    @Override
    public void dispatch() throws OperatorPrefixDoesNotExistException, NoSuchPhoneException, InsuficientBalanceException, NegativeBalanceValueException, InvalidDurationException, NoActiveCommunicationException {
