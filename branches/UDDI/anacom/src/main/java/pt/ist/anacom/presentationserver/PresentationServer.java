...
public class PresentationServer {
    ...
    public void ourMain() {
        ...
        increasePhoneBalanceCommand("911111111", 100);
        System.out.println(getPhoneBalanceCommand("911111111"));
        System.out.println(getBalanceAndPhoneListCommand("91"));

        setPhoneStateCommand("911111111", AnacomData.State.ON);
        System.out.println(getPhoneStateCommand("911111111"));
        setPhoneStateCommand("911111112", AnacomData.State.SILENCE);
        System.out.println(getPhoneStateCommand("911111112"));

        sendSMSCommand("911111111", "911111112", "Avozinho");

        System.out.println(getLastMadeCommunication("911111111"));

        System.out.println(getPhoneReceivedSMSListCommand("911111112"));
    ...
    private static CommunicationDto getLastMadeCommunication(String phoneNumber) {
        try {
