...
public interface AnacomServiceAsync {
    ...
    void setPhoneState(PhoneAndStateDto setStateDto, AsyncCallback<Void> callback);
    ...
    void getLastMadeCommunication(PhoneSimpleDto phoneDto, AsyncCallback<CommunicationDto> callback);
