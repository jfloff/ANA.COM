...
public class EndSendVoiceCallStrategy extends WriteCommandStrategy {

    private final CommunicationDurationDto communicationDurationDto;
    private final CommunicationDurationType communicationType;

    public EndSendVoiceCallStrategy(BusinessQueryManager businessQueryManager, CommunicationDurationDto communicationDurationDto, String prefix) throws MalformedURLException {
    ...
    public void sendToReplicas() {
        for (String url : urlList) {
            ...
            Logger.getLogger(this.getClass()).info("[ANACOM] Async endSendVoiceCall(" + communicationDurationDto.getSourcePhoneNumber() + ", "
            ...
            if (port != null) {
                ...
                port.endSendVoiceCallAsync(communicationType, handlerResponse);
            }
        }
    }
}
