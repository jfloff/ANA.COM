...
public class PresentationServer {
    ...
    public void ourMain() {
        ...
        //
        // Logger.getLogger(this.getClass()).info("PHONE 912222222 " + "WITH STATE: " +
        // getPhoneStateCommand("912222222"));
        ...
        //
        //
        // Logger.getLogger(this.getClass()).info("LAST COMMUNICATION: " +
        // getLastMadeCommunicationCommand("911111111"));
        // Logger.getLogger(this.getClass()).info("Read lastCommunicationCommand success");
        //
        // Logger.getLogger(this.getClass()).info("SMS LIST RECEIVED: " +
        // getSMSPhoneReceivedListCommand("912222222"));
        // Logger.getLogger(this.getClass()).info("Read smsPhoneReceivedListCommand success");

        // System.out.println("BALANCE AND PHONES LIST: " +
        // getBalanceAndPhoneListCommand("91"));
        ...
        //
        // Logger.getLogger(this.getClass()).info(getPhoneStateCommand("911111111"));
        // Logger.getLogger(this.getClass()).info(getPhoneStateCommand("931111111"));
        //
        // // Testing
        ...
        // sendSMSCommand("911111111", "912222222", "O edgar é bué BRUTO!");
        //
        // Logger.getLogger(this.getClass()).info("[STARTING SIMULATING VOICE CALL]");
        // try {
        // Thread.sleep(2000);
        ...
        // Logger.getLogger(this.getClass()).info(getPhoneStateCommand("911111111"));
        // Logger.getLogger(this.getClass()).info(getPhoneStateCommand("931111111"));
        // Logger.getLogger(this.getClass()).info(getLastMadeCommunication("911111111"));
        //
        // try {
        // Thread.sleep(2000);
        // } catch (InterruptedException e) {
        ...
        // Logger.getLogger(this.getClass()).info("[ENDING SIMULATING VOICE CALL]");
        //
        //
        // Logger.getLogger(this.getClass()).info(getPhoneStateCommand("911111111"));
        // Logger.getLogger(this.getClass()).info(getPhoneStateCommand("931111111"));
        //
        // System.out.println(getLastMadeCommunicationCommand("911111111"));
