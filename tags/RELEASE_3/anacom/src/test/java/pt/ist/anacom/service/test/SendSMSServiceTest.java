...
public class SendSMSServiceTest extends AnacomServiceTestCase {
	...
	public void setUp() {
		...
		addPhone(OPERATOR_PREFIX, SMS_NUMBER_SEND_ON, PHONE_BALANCE, State.MobileStateON);
		addPhone(OPERATOR_PREFIX, SMS_NUMBER_RECEIVE_ON, PHONE_BALANCE, State.MobileStateON);
		addPhone(OPERATOR_PREFIX, SMS_NUMBER_SEND_OFF, PHONE_BALANCE, State.MobileStateOFF);
		addPhone(OPERATOR_PREFIX, SMS_NUMBER_RECEIVE_OFF, PHONE_BALANCE, State.MobileStateOFF);
		addPhone(OPERATOR_PREFIX, SMS_NUMBER_SEND_BUSY, PHONE_BALANCE, State.MobileStateBUSY);
	}
