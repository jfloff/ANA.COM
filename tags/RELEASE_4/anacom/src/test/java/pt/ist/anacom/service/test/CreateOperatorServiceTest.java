...
public class CreateOperatorServiceTest extends AnacomServiceTestCase {
    ...
    public void testCreateOperator() {
        ...
        // Arrange
        OperatorDetailedDto dto = new OperatorDetailedDto(OPERATOR_PREFIX, OPERATOR_NAME, TAX, VOICETAX, SMSTAX, VIDEOTAX);
    ...
    public void testCreateOperatorWithWrongPrefix() {
        ...
        // Arrange
        OperatorDetailedDto dto = new OperatorDetailedDto(OPERATOR_WRONG_PREFIX, OPERATOR_NAME, TAX, VOICETAX, SMSTAX, VIDEOTAX);
        RegisterNewOperatorService createService = new RegisterNewOperatorService(dto);
    ...
    public void testCreateOperatorWithoutName() {
        ...
        // Arrange
        OperatorDetailedDto dto = new OperatorDetailedDto(OPERATOR_PREFIX, null, TAX, VOICETAX, SMSTAX, VIDEOTAX);
        RegisterNewOperatorService createService = new RegisterNewOperatorService(dto);
    ...
    public void testCreateDuplicateOperator() {
        ...
        // Arrange
        OperatorDetailedDto dto = new OperatorDetailedDto(OPERATOR_PREFIX_OTHER, OPERATOR_NAME_OTHER, TAX, VOICETAX, SMSTAX, VIDEOTAX);
        RegisterNewOperatorService createService = new RegisterNewOperatorService(dto);
