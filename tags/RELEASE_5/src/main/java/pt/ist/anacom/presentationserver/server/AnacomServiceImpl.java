...
public class AnacomServiceImpl extends RemoteServiceServlet implements AnacomService {
    ...
    @Override
    public void setPhoneState(PhoneAndStateDto setStateDto) throws OperatorPrefixDoesNotExistException, NoSuchPhoneException,CouldNotSetStateWhileCommunicationActiveException {
    ...
    @Override
    public LastCommunicationDto getLastMadeCommunication(PhoneSimpleDto phoneDto) throws NoSuchPhoneException,
            OperatorPrefixDoesNotExistException,
