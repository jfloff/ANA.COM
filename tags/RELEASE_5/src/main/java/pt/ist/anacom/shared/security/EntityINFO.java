...
public class EntityINFO {
    ...
    public void setContains(byte[] contents) {
    ...
    public void addRevokedCertificate(SignedCertificate revokedCertificate) {
        if (!this.revokedList.contains(revokedCertificate))
            this.revokedList.add(revokedCertificate);
    }
}
