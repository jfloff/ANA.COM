...
public interface AnacomServiceAsync {
    ...
    void getPhoneBalance(PhoneSimpleDto phoneDto, AsyncCallback<BalanceDto> callback) throws OperatorPrefixDoesNotExistException,
            NoSuchPhoneException;

    void increaseBalance(BalanceAndPhoneDto incBalDto, AsyncCallback<Void> callback) throws NoSuchPhoneException,
    ...
    void setPhoneState(PhoneAndStateDto setStateDto, AsyncCallback<Void> callback) throws OperatorPrefixDoesNotExistException, NoSuchPhoneException, CouldNotSetStateWhileCommunicationActiveException;

    void sendSMS(SMSDto SMSDto, AsyncCallback<Void> callback) throws NoSuchPhoneException,
            OperatorPrefixDoesNotExistException,
    ...
    void getSMSPhoneReceivedList(PhoneSimpleDto phoneDto, AsyncCallback<SMSPhoneReceivedListDto> callback) throws OperatorPrefixDoesNotExistException,
            NoSuchPhoneException;

    void getLastMadeCommunication(PhoneSimpleDto phoneDto, AsyncCallback<LastCommunicationDto> callback) throws NoSuchPhoneException,
            OperatorPrefixDoesNotExistException,
            NoCommunicationsMadeYetException;

    void startVoiceCall(CommunicationDto voiceCallDto, AsyncCallback<Void> callback) throws NoSuchPhoneException,
            OperatorPrefixDoesNotExistException,
            NegativeBalanceValueException,
            InsuficientBalanceException,
            PhoneStateException;

    void endVoiceCall(CommunicationDurationDto voiceEndCallDto, AsyncCallback<Void> callback) throws NoSuchPhoneException,
            OperatorPrefixDoesNotExistException,
            NegativeBalanceValueException,
            InsuficientBalanceException,
