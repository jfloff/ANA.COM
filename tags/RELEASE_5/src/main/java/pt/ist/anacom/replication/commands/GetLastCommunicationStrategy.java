...
import pt.ist.anacom.replication.vote.LastCommunicationTypeVoteList;
...
public class GetLastCommunicationStrategy extends GetCommandStrategy {
    ...
    public void vote() {
        ...
        voteList = new LastCommunicationTypeVoteList(responseListVersion, responseListObject, responseList.keySet());
